...
async def set_language(message: types.Message, state: FSMContext):
    ...
    await message.answer("\U0001F44B Вітаю тебе в сигнальному боті для слотів у казино!\n"
...
async def after_register(callback_query: types.CallbackQuery):
    await callback_query.message.edit_text("‼️ Увага! Перед початком обов’язкові дії:\n"
